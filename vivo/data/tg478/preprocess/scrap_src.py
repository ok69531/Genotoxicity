...
tg478_path1 = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[34]'
driver.find_element(By.XPATH, tg478_path1).click()
time.sleep(0.5)

tg478_path2 = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[35]'
driver.find_element(By.XPATH, tg478_path2).click()
time.sleep(0.5)
...
print(f'number of results: {len(result_)}')


#%%
json.dump(result_, open('tg478_page_src.json', 'w'))
