...
#%%
df_tmp = pd.read_excel('tg478_raw.xlsx')
...
#%%
geno_consv.to_excel('../tg478_consv.xlsx', index = False, header = True)
geno_maj.to_excel('../tg478_maj.xlsx', index = False, header = True)
