...
tg475_path1 = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[31]'
driver.find_element(By.XPATH, tg475_path1).click()
time.sleep(0.5)

tg475_path2 = '/html/body/ng-dropdown-panel/div[2]/div[2]/div[32]'
driver.find_element(By.XPATH, tg475_path2).click()
time.sleep(0.5)
...
#%%
json.dump(result_, open('tg475_page_src.json', 'w'))
