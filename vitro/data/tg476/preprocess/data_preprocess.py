...
pn_map = pd.read_csv('tg476_pn_map.csv')
...
# pn_map['genotoxicity'][1] = 'positive'
# pn_map.to_csv('tg476_pn_map.csv', header = True, index = False)
...
#%%
result.to_excel('../tg476_tmp.xlsx', index = False, header = True)
